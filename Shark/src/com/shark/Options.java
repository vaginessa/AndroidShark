...
public class Options extends Activity {
			...
			public void onClick(View v) {
				if ((save_checkbox.isChecked())
					...
					new AlertDialog.Builder(Options.this)
							...
							.setMessage(
									"Shark has detected that you want to save the packets to a file but the filename you entered is empty.")
	...
	private void restorePreferences() {
		...
		file_text.setText(settings.getString("fileText", "shark_capture.pcap"));
